...
Shader "UnityPBR"
{
	Properties
	{
		...
		[ASEEnd][ASEBegin][Normal]_NormalMap("NormalMap", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 tanNormal25 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap ), 1.0f );
				float3 worldNormal25 = float3(dot(tanToWorld0,tanNormal25), dot(tanToWorld1,tanNormal25), dot(tanToWorld2,tanNormal25));
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = worldNormal25;
				float Alpha = 1;
...
/*ASEBEGIN
Version=19102
Node;AmplifyShaderEditor.SamplerNode;10;-612.5,-113.5;Inherit;True;Property;_Albedo;Albedo;0;0;Create;True;0;0;0;False;0;False;-1;None;dc3400a34bf99724bbaa3e35eb7e1a4f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.WorldNormalVector;25;-254.179,-0.6906128;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
WireConnection;13;0;12;1
WireConnection;16;2;25;0
WireConnection;25;0;14;0
ASEEND*/
//CHKSM=9682111530FDDCE4AB27FD26828BA42F835CBFE6