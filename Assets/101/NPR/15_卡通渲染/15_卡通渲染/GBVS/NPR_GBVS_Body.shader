Shader "NPR/GBVS_Body"
{
    ...
    Properties
    {
        ...
        [NoScaleOffset]_DecalLerp("DecalLerp",Range(0,1)) =0
        [Space(30)]
...
//=========================== SimpleShaderGUI 分组 ======================================//
        ...
        [SubToggle(Layer1,_Layer1_HasTwoStepDiffuse)] _Layer1_HasTwoStepDiffuse("有两层明暗面?",Float) = 0
        [SubToggleItem(Layer1,_Layer1_HasTwoStepDiffuse)] _Layer1_RampOffset2("第二层Ramp偏移值",Float) = 0.15
//        //[Space(10)]
...
//        [SubToggleItem(Layer1,_Layer1_HasRim)] _Layer1_Rim_Exp ("边缘光 曲率",Float) =1
        ...
        //[Space(10)]
        [SubToggle(Layer1,_Layer1_HasViewLightFalloff)] _Layer1_HasViewLightFalloff("视角过渡光?",Float) = 0
        [SubToggleItem(Layer1,_Layer1_HasViewLightFalloff)] _Layer1_ViewLight_Intensity("视角过渡光 强度?",Float) =1
        [SubToggleItem(Layer1,_Layer1_HasViewLightFalloff)] _Layer1_ViewLight_Exp ("视角过渡光 曲率?",Float) =1
        
        //===========================Layer2 ======================================//
        [Main(Layer2)] _Layer2("_Layer2 布料1",Float) = 0
        [SubToggle(Layer2,_Layer2_HasTwoStepDiffuse)] _Layer2_HasTwoStepDiffuse("有两层明暗面?",Float) = 0
        [SubToggleItem(Layer2,_Layer2_HasTwoStepDiffuse)] _Layer2_RampOffset2("第二层Ramp偏移值",Float) = 0.15
        //[Space(10)]
...
//        [SubToggleItem(Layer2,_Layer2_HasRim)] _Layer2_Rim_Exp ("边缘光 曲率",Float) =1
        ...
        //[Space(10)]
        [SubToggle(Layer2,_Layer2_HasViewLightFalloff)] _Layer2_HasViewLightFalloff("视角过渡光?",Float) = 0
        [SubToggleItem(Layer2,_Layer2_HasViewLightFalloff)] _Layer2_ViewLight_Intensity("视角过渡光 强度?",Float) =1
        [SubToggleItem(Layer2,_Layer2_HasViewLightFalloff)] _Layer2_ViewLight_Exp ("视角过渡光 曲率?",Float) =1
        
        //===========================Layer3 ======================================//
        [Main(Layer3)] _Layer3("_Layer3 布料2",Float) = 0
        [SubToggle(Layer3,_Layer3_HasTwoStepDiffuse)] _Layer3_HasTwoStepDiffuse("有两层明暗面?",Float) = 0
        [SubToggleItem(Layer3,_Layer3_HasTwoStepDiffuse)] _Layer3_RampOffset2("第二层Ramp偏移值",Float) = 0.15
        //[Space(10)]
...
//        [SubToggleItem(Layer3,_Layer3_HasRim)] _Layer3_Rim_Exp ("边缘光 曲率",Float) =1
        ...
        //[Space(10)]
        [SubToggle(Layer3,_Layer3_HasViewLightFalloff)] _Layer3_HasViewLightFalloff("视角过渡光?",Float) = 0
        [SubToggleItem(Layer3,_Layer3_HasViewLightFalloff)] _Layer3_ViewLight_Intensity("视角过渡光 强度?",Float) =1
        [SubToggleItem(Layer3,_Layer3_HasViewLightFalloff)] _Layer3_ViewLight_Exp ("视角过渡光 曲率?",Float) =1
        
        //===========================Layer4 ======================================//
        [Main(Layer4)] _Layer4("_Layer4 布料3",Float) = 0
        [SubToggle(Layer4,_Layer4_HasTwoStepDiffuse)] _Layer4_HasTwoStepDiffuse("有两层明暗面?",Float) = 0
        [SubToggleItem(Layer4,_Layer4_HasTwoStepDiffuse)] _Layer4_RampOffset2("第二层Ramp偏移值",Float) = 0.15
        //[Space(10)]
...
//        [SubToggleItem(Layer4,_Layer4_HasRim)] _Layer4_Rim_Exp ("边缘光 曲率",Float) =1
        ...
        //[Space(10)]
        [SubToggle(Layer4,_Layer4_HasViewLightFalloff)] _Layer4_HasViewLightFalloff("视角过渡光?",Float) = 0
        [SubToggleItem(Layer4,_Layer4_HasViewLightFalloff)] _Layer4_ViewLight_Intensity("视角过渡光 强度?",Float) =1
        [SubToggleItem(Layer4,_Layer4_HasViewLightFalloff)] _Layer4_ViewLight_Exp ("视角过渡光 曲率?",Float) =1
        
        //===========================Layer5 ======================================//
        [Main(Layer5)] _Layer5("_Layer5 皮革1",Float) = 0
        [SubToggle(Layer5,_Layer5_HasTwoStepDiffuse)] _Layer5_HasTwoStepDiffuse("有两层明暗面?",Float) = 0
        [SubToggleItem(Layer5,_Layer5_HasTwoStepDiffuse)] _Layer5_RampOffset2("第二层Ramp偏移值",Float) = 0.15
        //[Space(10)]
...
//        [SubToggleItem(Layer5,_Layer5_HasRim)] _Layer5_Rim_Exp ("边缘光 曲率",Float) =1
        ...
        //[Space(10)]
        [SubToggle(Layer5,_Layer5_HasViewLightFalloff)] _Layer5_HasViewLightFalloff("视角过渡光?",Float) = 0
        [SubToggleItem(Layer5,_Layer5_HasViewLightFalloff)] _Layer5_ViewLight_Intensity("视角过渡光 强度?",Float) =1
        [SubToggleItem(Layer5,_Layer5_HasViewLightFalloff)] _Layer5_ViewLight_Exp ("视角过渡光 曲率?",Float) =1
        
        //===========================Layer6 ======================================//
        [Main(Layer6)] _Layer6("_Layer6 皮革2",Float) = 0
        [SubToggle(Layer6,_Layer6_HasTwoStepDiffuse)] _Layer6_HasTwoStepDiffuse("有两层明暗面?",Float) = 0
        [SubToggleItem(Layer6,_Layer6_HasTwoStepDiffuse)] _Layer6_RampOffset2("第二层Ramp偏移值",Float) = 0.15
        //[Space(10)]
...
//        [SubToggleItem(Layer6,_Layer6_HasRim)] _Layer6_Rim_Exp ("边缘光 曲率",Float) =1
        ...
        //[Space(10)]
        [SubToggle(Layer6,_Layer6_HasViewLightFalloff)] _Layer6_HasViewLightFalloff("视角过渡光?",Float) = 0
        [SubToggleItem(Layer6,_Layer6_HasViewLightFalloff)] _Layer6_ViewLight_Intensity("视角过渡光 强度?",Float) =1
        [SubToggleItem(Layer6,_Layer6_HasViewLightFalloff)] _Layer6_ViewLight_Exp ("视角过渡光 曲率?",Float) =1
        
        //===========================Layer7 ======================================//
        [Main(Layer7)] _Layer7("_Layer7 皮革3",Float) = 0
        [SubToggle(Layer7,_Layer7_HasTwoStepDiffuse)] _Layer7_HasTwoStepDiffuse("有两层明暗面?",Float) = 0
        [SubToggleItem(Layer7,_Layer7_HasTwoStepDiffuse)] _Layer7_RampOffset2("第二层Ramp偏移值",Float) = 0.15
        //[Space(10)]
...
//        [SubToggleItem(Layer7,_Layer7_HasRim)] _Layer7_Rim_Exp ("边缘光 曲率",Float) =1
        ...
        //[Space(10)]
        [SubToggle(Layer7,_Layer7_HasViewLightFalloff)] _Layer7_HasViewLightFalloff("视角过渡光?",Float) = 0
        [SubToggleItem(Layer7,_Layer7_HasViewLightFalloff)] _Layer7_ViewLight_Intensity("视角过渡光 强度?",Float) =1
        [SubToggleItem(Layer7,_Layer7_HasViewLightFalloff)] _Layer7_ViewLight_Exp ("视角过渡光 曲率?",Float) =1
        
        //===========================Layer8 ======================================//
        [Main(Layer8)] _Layer8("_Layer8 金属1",Float) = 0
        [SubToggle(Layer8,_Layer8_HasTwoStepDiffuse)] _Layer8_HasTwoStepDiffuse("有两层明暗面?",Float) = 0
        [SubToggleItem(Layer8,_Layer8_HasTwoStepDiffuse)] _Layer8_RampOffset2("第二层Ramp偏移值",Float) = 0.15
        //[Space(10)]
...
//        [SubToggleItem(Layer8,_Layer8_HasRim)] _Layer8_Rim_Exp ("边缘光 曲率",Float) =1
        ...
        //[Space(10)]
        [SubToggle(Layer8,_Layer8_HasViewLightFalloff)] _Layer8_HasViewLightFalloff("视角过渡光?",Float) = 0
        [SubToggleItem(Layer8,_Layer8_HasViewLightFalloff)] _Layer8_ViewLight_Intensity("视角过渡光 强度?",Float) =1
        [SubToggleItem(Layer8,_Layer8_HasViewLightFalloff)] _Layer8_ViewLight_Exp ("视角过渡光 曲率?",Float) =1
        //===========================Layer9 ======================================//
        [Main(Layer9)] _Layer9("_Layer9 金属2",Float) = 0
        [SubToggle(Layer9,_Layer9_HasTwoStepDiffuse)] _Layer9_HasTwoStepDiffuse("有两层明暗面?",Float) = 0
        [SubToggleItem(Layer9,_Layer9_HasTwoStepDiffuse)] _Layer9_RampOffset2("第二层Ramp偏移值",Float) = 0.15
        //[Space(10)]
...
//        [SubToggleItem(Layer9,_Layer9_HasRim)] _Layer9_Rim_Exp ("边缘光 曲率",Float) =1
        ...
        //[Space(10)]
        [SubToggle(Layer9,_Layer9_HasViewLightFalloff)] _Layer9_HasViewLightFalloff("视角过渡光?",Float) = 0
        [SubToggleItem(Layer9,_Layer9_HasViewLightFalloff)] _Layer9_ViewLight_Intensity("视角过渡光 强度?",Float) =1
        [SubToggleItem(Layer9,_Layer9_HasViewLightFalloff)] _Layer9_ViewLight_Exp ("视角过渡光 曲率?",Float) =1
        //===========================Layer10 ======================================//
        [Main(Layer10)] _Layer10("_Layer10 金属3",Float) = 0
        [SubToggle(Layer10,_Layer10_HasTwoStepDiffuse)] _Layer10_HasTwoStepDiffuse("有两层明暗面?",Float) = 0
        [SubToggleItem(Layer10,_Layer10_HasTwoStepDiffuse)] _Layer10_RampOffset2("第二层Ramp偏移值",Float) = 0.15
        //[Space(10)]
...
//        [SubToggleItem(Layer10,_Layer10_HasRim)] _Layer10_Rim_Exp ("边缘光 曲率",Float) =1
        ...
        //[Space(10)]
        [SubToggle(Layer10,_Layer10_HasViewLightFalloff)] _Layer10_HasViewLightFalloff("视角过渡光?",Float) = 0
        [SubToggleItem(Layer10,_Layer10_HasViewLightFalloff)] _Layer10_ViewLight_Intensity("视角过渡光 强度?",Float) =1
        [SubToggleItem(Layer10,_Layer10_HasViewLightFalloff)] _Layer10_ViewLight_Exp ("视角过渡光 曲率?",Float) =1
        
        //===========================Layer11 ======================================//
        [Main(Layer11)] _Layer11("_Layer11 金属4",Float) = 0
        [SubToggle(Layer11,_Layer11_HasTwoStepDiffuse)] _Layer11_HasTwoStepDiffuse("有两层明暗面?",Float) = 0
        [SubToggleItem(Layer11,_Layer11_HasTwoStepDiffuse)] _Layer11_RampOffset2("第二层Ramp偏移值",Float) = 0.15
        //[Space(10)]
...
//        [SubToggleItem(Layer11,_Layer11_HasRim)] _Layer11_Rim_Exp ("边缘光 曲率",Float) =1
        ...
        //[Space(10)]
        [SubToggle(Layer11,_Layer11_HasViewLightFalloff)] _Layer11_HasViewLightFalloff("视角过渡光?",Float) = 0
        [SubToggleItem(Layer11,_Layer11_HasViewLightFalloff)] _Layer11_ViewLight_Intensity("视角过渡光 强度?",Float) =1
        [SubToggleItem(Layer11,_Layer11_HasViewLightFalloff)] _Layer11_ViewLight_Exp ("视角过渡光 曲率?",Float) =1
        
//         [Main(GroupIsGood)] Group("分组大法好",Float) = 0
//         [Sub(GroupIsGood)] Group_Float("分组大法好 里的Float",Float) = 0
//         [Sub(GroupIsGood)] Group_Color("分组大法好 里的Color",Color) = (1,0,0,0)
    }
...
///通用参数
///=================================================================//
            sampler2D _BaseMap, _ShadowMap, _LightMap, _DecalMap;
...
//===========================Layer1 ======================================//
            bool _Layer1_HasTwoStepDiffuse,_Layer1_HasSpecular,_Layer1_HasStepSpecular,_Layer1_HasRim,_Layer1_HasViewLightFalloff;
...
//===========================Layer2 ======================================//
            bool _Layer2_HasTwoStepDiffuse,_Layer2_HasSpecular,_Layer2_HasStepSpecular,_Layer2_HasRim,_Layer2_HasViewLightFalloff;
...
//===========================Layer3 ======================================//
            bool _Layer3_HasTwoStepDiffuse,_Layer3_HasSpecular,_Layer3_HasStepSpecular,_Layer3_HasRim,_Layer3_HasViewLightFalloff;
...
//===========================Layer4 ======================================//
            bool _Layer4_HasTwoStepDiffuse,_Layer4_HasSpecular,_Layer4_HasStepSpecular,_Layer4_HasRim,_Layer4_HasViewLightFalloff;
...
//===========================Layer5 ======================================//
            bool _Layer5_HasTwoStepDiffuse,_Layer5_HasSpecular,_Layer5_HasStepSpecular,_Layer5_HasRim,_Layer5_HasViewLightFalloff;
...
//===========================Layer6 ======================================//
            bool _Layer6_HasTwoStepDiffuse,_Layer6_HasSpecular,_Layer6_HasStepSpecular,_Layer6_HasRim,_Layer6_HasViewLightFalloff;
...
//===========================Layer7 ======================================//
            bool _Layer7_HasTwoStepDiffuse,_Layer7_HasSpecular,_Layer7_HasStepSpecular,_Layer7_HasRim,_Layer7_HasViewLightFalloff;
...
//===========================Layer8 ======================================//
            bool _Layer8_HasTwoStepDiffuse,_Layer8_HasSpecular,_Layer8_HasStepSpecular,_Layer8_HasRim,_Layer8_HasViewLightFalloff;
...
//===========================Layer9 ======================================//
            bool _Layer9_HasTwoStepDiffuse,_Layer9_HasSpecular,_Layer9_HasStepSpecular,_Layer9_HasRim,_Layer9_HasViewLightFalloff;
...
//===========================Layer10 ======================================//
            bool _Layer10_HasTwoStepDiffuse,_Layer10_HasSpecular,_Layer10_HasStepSpecular,_Layer10_HasRim,_Layer10_HasViewLightFalloff;
...
//===========================Layer11 ======================================//
            bool _Layer11_HasTwoStepDiffuse,_Layer11_HasSpecular,_Layer11_HasStepSpecular,_Layer11_HasRim,_Layer11_HasViewLightFalloff;
...
//===========================补充参数 ======================================//
            ...
            struct NPRData
            {
                ...
                float ShadowMask, RampOffsetMask, SpecularIntensityMask, SpecularExpMask , NL01, NH, NV,NL;
                
                //每层不一样的参数
                bool HasTwoStepDiffuse,HasRim,HasSpecular,HasStepSpecular,HasViewLightFalloff;
            ...
            float3 NPRLighting(in NPRData nprData)
            {
                ...
                float3 DarkSide   = nprData.ShadowMap * _DarkIntensity;//暗部
                float3 BrightSide = nprData.BaseMap * _BrightIntensity;//亮部
                ...
                if(nprData.HasRim)
                {
                    ...
                    float3 Rim = step(1-nprData.Rim_Width, 1 - nprData.NV) * nprData.Rim_Intensity*nprData.ShadowMask;//ShadowMask 部分不出现边缘光

                    if(BothSideRim) Final += Rim*nprData.BaseMap;            //整体(亮部、暗部) 加上边缘光
                    if(OnlyBrightSideRim) BrightSide += Rim*nprData.BaseMap; //亮部 加上边缘光
                    if(OnlyDarkSideRim) DarkSide += Rim*nprData.BaseMap;     //暗部 加上边缘光
                    
                    // Final += Rim*nprData.BaseMap;
                }

                //两层裁边漫反射
                if (nprData.HasTwoStepDiffuse)
                {
                    if (_LightThreshold < nprData.ShadowMask * (nprData.NL01 + _RampOffset +  nprData.RampOffset2 + nprData.RampOffsetMask))
                    {
                        StepValue = 0.5;
                    }
                }
                ...
                //一层裁边漫
                if (_LightThreshold < nprData.ShadowMask * (nprData.NL01 + _RampOffset + 0 + nprData.RampOffsetMask))
                {
                    StepValue = 1;
                }
                
                //视角过渡光
                if (nprData.HasViewLightFalloff)
                {
                ...
                /*
                //float3 Specular = max(0, pow((nprData.NH), 32 * nprData.SpecularExpMask) * 2 * nprData.SpecularIntensityMask);
                float3 Specular = max(0, pow((nprData.NH), 32 * 1) * 2 * nprData.SpecularIntensityMask);
                ...
                */
                ...
                {
                    float stepSpecularTypeValue = nprData.StepSpecularType ==0 ? nprData.NH:nprData.NV;//选择NV 或者NH
                    float3 StepSpecular = step(1 - nprData.StepSpecular_Width, stepSpecularTypeValue) * nprData.StepSpecular_Intensity;
            ...
            float4 frag(VertexToFragmentData i) : SV_Target
            {
                ...
                float RampOffsetMask        = LightMap.g*2-1; //Ramp偏移值,值越大的区域 越容易"感光"(在一个特定的角度，偏移光照明暗)
                ...
                #ifdef DebugMode
                {
                    int mode = 1;
                    if (_TestMode == mode++)
                        return tex2D(_BaseMap, uv).xyzz; //BaseColor
                    if (_TestMode == mode++)
                        return lerp(BaseMap,0, step(_LayerStep, BaseMap.a)); //test layer
                    if (_TestMode == mode++)
                        return  tex2D(_BaseMap, uv).a; //BaseMap.a
                    if (_TestMode == mode++)
